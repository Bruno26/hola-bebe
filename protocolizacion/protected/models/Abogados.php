...
class Abogados extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, persona_id, inpreabogado, tipo_abogado_id, oficina_id, observaciones, estatus, fecha_creacion, fecha_actualizacion, usuario_id_creacion, usuario_id_actualizacion', 'safe', 'on'=>'search'),
		);
	}
