...
class AsignacionCenso extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_asignacion_censo, unidad_habitacional_id, oficina_id, persona_id, fecha_asignacion, censado, estatus, observaciones, fecha_creacion, fecha_actualizacion, usuario_id_creacion, usuario_id_actualizacion', 'safe', 'on'=>'search'),
		);
	}
